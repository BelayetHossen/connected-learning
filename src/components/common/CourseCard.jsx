            ...
            <div className='bg-white p-5 rounded-xl hover:shadow-xl hover:scale-95 transition duration-500'>
                <div className='relative'>
                    <img
                        ...
                        alt="nature image"
                    />
                    <span className="absolute top-2 right-2 z-10 px-2 py-1 bg-[#ffffffcc] rounded-xl text-blue-500">{category}</span>
