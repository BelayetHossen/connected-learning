        ...
        <>
            <div className="container mx-auto md:px-14 px-4 py-14 md:flex flex-col md:flex-row gap-10 h-[700px]">
                <div className="relative md:w-1/2">
                    ...
                    <div className="absolute top-14 left-0 w-[500px] h-[350px] rounded-xl bg-transparent border-2 border-[#6278FF] hidden md:block" />
                ...
                <div className="md:w-1/2 mt-84">
                    <h4 className="text-[#6278FF] font-bold text-xl">About Us</h4>
                    ...
                    <button className="bg-[#6278FF] hover:bg-blue-700 py-2 px-4 rounded-full text-white mt-4">Learn More</button>
                </div>
            </div>
        </>
    );
