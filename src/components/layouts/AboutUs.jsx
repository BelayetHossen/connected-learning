...
const AboutUs = () => {
    return (
        <>
            <div className="container mx-auto md:px-14 px-4 pt-14 pb-24 md:flex flex-col md:flex-row gap-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0">
                    <h4 className="text-[#6278FF] font-bold text-xl mb-3">About Us</h4>
                    <h3 className="text-gray-900 font-bold text-3xl md:text-4xl py-3 md:w-[500px]">
                        We are providing the best online digital courses.
                    </h3>
                    <p className="text-gray-600 text-sm py-2">
                        Contrary to popular belief, Lorem Ipsum is not simply random text. It has roo piece of classical Latin
                        literature from 45 BC, making it over 2000 years old. Ri chard McClintock, a Latin professor at
                        Hampden-Sydney College in Virginia, l ooked up one of the more obscure Latin words, consectetur, from a
                        Lorem Ips um passage, and going through the cites of the word in classical literature, di scovered the
                        undoubtable source
                    </p>
                    <p className="text-gray-600 text-sm py-2">
                        Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of de Finibus Bonoru et Malorum (The Extremes of
                        Good and Evil) by Cicero, written in 45 BC. This book is a treatise on.
                    </p>
                    <button className="bg-[#6278FF] hover:bg-blue-700 py-2 px-4 rounded-full text-white mt-4">
                        Learn More
                    </button>
                </div>
            </div>
